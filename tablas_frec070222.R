...
#_____________ tablas de frecuencia____________
...
#1.-Exploración de matriz
data(iris)

#2.- Exploración de la matriz
#tenemos 150individuos y 5 variables
dim(iris
...
#1. Convertir la amtriz de datos a una data frame,
